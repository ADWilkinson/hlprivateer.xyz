...
export function PnlPanel({ snapshot, chart, isLoading = false }: PnlPanelProps) {
  ...
  return (
    <section className={cardClass}>
      ...
      <section className='grid grid-cols-1 gap-2 xl:grid-cols-[minmax(220px,420px)_1fr] min-h-[286px]'>
        <div className='flex min-h-[134px] flex-col justify-center gap-2 border border-hlpBorder dark:border-hlpBorderDark bg-hlpPanel dark:bg-hlpPanelDark rounded-hlp p-4'>
        ...
        <div className='flex min-h-[134px] flex-col rounded-hlp border border-hlpBorder dark:border-hlpBorderDark bg-hlpPanel dark:bg-hlpPanelDark p-3'>
