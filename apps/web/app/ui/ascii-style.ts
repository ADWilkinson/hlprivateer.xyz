...
export const cardClass =
  `relative overflow-hidden animate-hlp-fade-up ${panelRadius} border border-hlpBorder bg-hlpPanel/95 text-hlpFg shadow-hlp`

export const cardHeaderClass =
  `flex items-center justify-between border-b border-hlpBorder bg-hlpSurface/70 ${panelHeaderPad} text-[9px] uppercase tracking-[0.24em] text-hlpMuted`
...
export const buttonClass =
  `inline-flex h-8 items-center ${panelRadiusSubtle} border border-hlpBorder bg-hlpSurface/70 px-2.5 text-[9px] uppercase tracking-[0.16em] text-hlpMuted transition-colors hover:border-hlpBorderStrong hover:text-hlpFg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hlpPositive/70`
...
export const terminalPanelClass =
  'max-h-[380px] min-h-0 overflow-y-auto overflow-x-hidden rounded-hlp border border-hlpBorder bg-hlpBg py-1 px-2'
...
export const monitorClass =
  'overflow-hidden rounded-hlp border border-hlpBorder bg-hlpSurface'
