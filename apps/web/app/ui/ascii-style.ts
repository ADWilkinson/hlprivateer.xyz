export const pageShellClass = 'w-full max-w-none flex flex-col gap-2 px-2 py-3 sm:px-4 sm:py-4 lg:px-6 2xl:px-8'
...
export const cardHeaderClass =
  'flex items-center justify-between border-b border-hlpBorder dark:border-hlpBorderDark bg-hlpSurface/70 dark:bg-hlpSurfaceDark/65 px-3 py-2 text-[9px] uppercase tracking-[0.24em] text-hlpMuted dark:text-hlpMutedDark'

export const inlineBadgeClass =
  'inline-flex h-5 items-center rounded-sm border border-hlpBorder dark:border-hlpBorderDark bg-hlpPanel/40 dark:bg-hlpPanelDark/45 px-2 py-1 text-[9px] uppercase tracking-[0.14em] text-hlpMuted dark:text-hlpMutedDark whitespace-nowrap'
...
export const terminalPanelClass =
  'max-h-[320px] min-h-0 overflow-y-auto overflow-x-hidden rounded-hlp border border-hlpBorder dark:border-hlpBorderDark bg-hlpBg dark:bg-hlpBgDark py-1 px-2'
...
export const sectionStripClass =
  'flex flex-wrap gap-1 border-t border-hlpBorder/85 dark:border-hlpBorderDark/85 px-2 py-2'
